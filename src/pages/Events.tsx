...
export default function Events() {
  ...
  // If the Excel didn't provide images, use the placeholder.
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-6 text-muted-foreground mb-8">
              <div className="flex items-center gap-2">
                ...
                <span>{/* If you want a dynamic date range, compute from agenda */}November 25-27, 2025</span>
              </div>
              <div className="flex items-center gap-2">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-12">
            {agenda.map((day: any, dayIndex: number) => (
              <div key={dayIndex}>
                <div className="mb-6">
                  <h3 className="text-2xl font-bold text-foreground">{day.day || `Day ${dayIndex+1}`}</h3>
